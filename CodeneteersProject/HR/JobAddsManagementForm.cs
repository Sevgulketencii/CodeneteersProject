...
namespace CodeneteersProject.HR
{
    public partial class JobAddsManagementForm : Form
    {
        ...
        {
            JobAddDetailForm jobbAddDetailForm = new JobAddDetailForm(jobAdvertisement, appUser);
            this.Hide();
            jobbAddDetailForm.ShowDialog();
        ...
        private void JobAddsManagementForm_Load(object sender, EventArgs e)
        {
