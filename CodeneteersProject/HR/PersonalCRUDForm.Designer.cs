...
namespace CodeneteersProject.HR
{
	partial class PersonalCRUDForm
	{
		...
		private void InitializeComponent()
		{
			...
			restIcon = new Guna2CircleButton();
			restButton = new Guna2Button();
			logOutButton = new Guna2Button();
			logOutIcon = new Guna2CircleButton();
			...
			companyIcon = new Guna2CircleButton();
			companyButton = new Guna2Button();
			...
			restButton.Location = new Point(62, 132);
			...
			txtPersonalName.CustomizableEdges = customizableEdges27;
			...
			txtPersonalName.ShadowDecoration.CustomizableEdges = customizableEdges28;
			...
			txtPersonalSurname.CustomizableEdges = customizableEdges29;
			...
			txtPersonalSurname.ShadowDecoration.CustomizableEdges = customizableEdges30;
			...
			ComboxGender.CustomizableEdges = customizableEdges33;
			...
			columnHeaderPersonalNo.Width = 85;
			// 
			// columnHeaderName
			// 
			columnHeaderName.Text = "Ad";
			columnHeaderName.Width = 85;
			// 
			// columnHeaderSurname
			// 
			columnHeaderSurname.Text = "Soyad";
			columnHeaderSurname.Width = 85;
			// 
			// icons
			// 
			...
			Controls.Add(DatePickerExitdate);
		...
		private Guna2CircleButton restIcon;
		private Guna2Button restButton;
		private Guna2Button logOutButton;
		private Guna2CircleButton logOutIcon;
		...
		private Guna2CircleButton companyIcon;
		private Guna2Button companyButton;
