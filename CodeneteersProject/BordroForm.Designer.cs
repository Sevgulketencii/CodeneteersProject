...
namespace CodeneteersProject
{
	partial class BordroForm
	{
		...
		private void InitializeComponent()
		{
			...
			personel_label.Location = new Point(50, 138);
			personel_label.Name = "personel_label";
			personel_label.Size = new Size(148, 33);
			...
			label2.Location = new Point(367, 70);
			label2.Name = "label2";
			...
			personel_salary.Size = new Size(2, 33);
			...
			personel_workedDays.Location = new Point(382, 138);
			personel_workedDays.Name = "personel_workedDays";
			personel_workedDays.Size = new Size(148, 33);
